...
var knownCityCenters = map[string]GeoPoint{
	...
	"semarang":         {Lat: -6.9667, Lon: 110.4167, CountryCode: "id", DisplayName: "Semarang"},
	"makassar":         {Lat: -5.1477, Lon: 119.4327, CountryCode: "id", DisplayName: "Makassar"},
	"batam":            {Lat: 1.0456, Lon: 104.0305, CountryCode: "id", DisplayName: "Batam"},
	"bekasi":           {Lat: -6.2383, Lon: 106.9756, CountryCode: "id", DisplayName: "Bekasi"},
	"tangerang":        {Lat: -6.1783, Lon: 106.6319, CountryCode: "id", DisplayName: "Tangerang"},
	"depok":            {Lat: -6.4025, Lon: 106.7942, CountryCode: "id", DisplayName: "Depok"},
	"bogor":            {Lat: -6.5971, Lon: 106.8060, CountryCode: "id", DisplayName: "Bogor"},
	"palembang":        {Lat: -2.9761, Lon: 104.7754, CountryCode: "id", DisplayName: "Palembang"},
	"denpasar":         {Lat: -8.6500, Lon: 115.2167, CountryCode: "id", DisplayName: "Denpasar"},
