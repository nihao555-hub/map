...
func Providers() []Provider {
	return []Provider{
		...
		},
		{
			...
			IMAPPort:       993,
			DomainSuffixes: []string{"qq.com", "vip.qq.com", "foxmail.com"},
		},
		{
			Name:           "网易 163 邮箱（个人，授权码）",
			SMTPHost:       "smtp.163.com",
			SMTPPort:       465,
			SMTPTLS:        TLSModeSSL,
			IMAPHost:       "imap.163.com",
			IMAPPort:       993,
			DomainSuffixes: []string{"163.com", "yeah.net"},
		},
		{
			Name:           "网易 126 邮箱（个人，授权码）",
			SMTPHost:       "smtp.126.com",
			SMTPPort:       465,
			SMTPTLS:        TLSModeSSL,
			IMAPHost:       "imap.126.com",
			IMAPPort:       993,
			DomainSuffixes: []string{"126.com"},
		},
		{
